...
public class BookControllerTest {
	...
	public void createBookTest() throws Exception {
		...
		// Metodo chama a instancia de service save o valor que retorna deve ser o
		// savedBook
	...
	public void updateBookTest() throws Exception {
		...
		Book updatedBook = Book.builder().id(id).author("TimTim").title("As Aventuras de Tim Tim").isbn("001232")
				.build();
